...
sidebar_position: 1
keywords: [red team, definitions, lexicon, terminology, security terms]
---
...
The blue cell is the opposite side of red. Is it all the components defending a target network. The blue cell is typically comprised of [blue team](#blue-team) members, defenders, internal staff, and an organization’s management. See [Roles and Relationships](/docs/Concepts/role-relationships) for more on how these groups interact.
...
Command and Control (C2) is the influence an attacker has over a compromised computer system that they control. See [Red Team Tradecraft and TTP Guidance](/docs/Planning/red-team-tradecraft) for C2 planning considerations.
...
Serves as referee between [Red Team](#red-team) activities and defender responses during an engagement. Controls the engagement environment/network. Monitors adherence to the [ROE](#rules-of-engagement-roe). Coordinates activities required to achieve engagement goals. Correlates Red Team activities with defensive actions. Ensures the engagement is conducted without bias to either side. See [Roles and Relationships](/docs/Concepts/role-relationships) for more detail.
...
The three main phases of a [Red Team](#red-team) engagement. See the [Red Team Checklist](/docs/checklists/red-team-checklist) for a step-by-step breakdown of each phase.
...
Operator logs are the records generated by [Red Team operators](#red-team-operator) during an engagement. These logs have specific and required fields that must be captured. See the [Operator Log Template](/docs/Templates/oplog) for required fields and format.
...
In terms of business risk, a penetration test should be considered an attack surface reduction effort as mitigation of the findings will ultimately lead to a reduction in the attack surface. Penetration tests do not typically focus on understanding how security operations as a whole can deal with a threat. See [Red Teaming](#red-teaming) and [Red Team Engagement vs Penetration Test vs Vulnerability Assessment](/docs/Concepts/red-vs-pen-vs-vuln) for a detailed comparison.
...
The term red cell is borrowed from the military. It is commonly associated with a group that plays [OPFOR](#opfor) (opposing force) during red vs. blue exercises. A red cell is the components that make up the offensive portion of a red team engagement that simulates the strategic and tactical responses of a given target. The red cell is typically comprised of [red team leads](#red-team-lead) and [operators](#red-team-operator) and is commonly referred to as Red Team instead of Red Cell. See [Roles and Relationships](/docs/Concepts/role-relationships).
...
Red teaming is the process of using [Tactics, Techniques, and Procedures (TTPs)](#ttps) to emulate real-world threats with the goal of training and measuring the effectiveness of the people, processes, and technology used to defend an environment. See [What is Red Teaming?](/docs/Concepts/red-teaming) for a full overview.
...
Serves as the operational and administrative lead for the [Red Team](#red-team). Conducts engagement, budget, and resource management for the Red Team. Provides oversight and guidance for engagements, capabilities, and technologies. Ensures adherence to all laws, regulations, policies, and [Rules of Engagement](#rules-of-engagement-roe). See [Roles and Relationships](/docs/Concepts/role-relationships) and [Goal Planning](/docs/Planning/goal-planning).
...
The Rules of Engagement establish the responsibilities, relationships, and guidelines among the [Red Team](#red-team), the customer, the system owner, and any stakeholders required for engagement execution. See [ROE Planning](/docs/checklists/roe-planning) and the [ROE Template](/docs/Templates/roe_template).
...
Threat Emulation is the process of mimicking the [TTPs](#ttps) of a specific threat. See the [Decomposing a Threat](/docs/Exercises/threat-profile) exercise and [example threat profiles](/docs/category/threat-profiles).
...
A threat profile is used to establish the rules as to how a [Red Team](#red-team) will act and operate. These rules serve as a roadmap for a Red Team by guiding how and what type of actions should be performed. Threat profiles are a key part of developing and designing [C2](#command-and-control-c2) early in Red Team planning. See [example threat profiles](/docs/category/threat-profiles) and the [Decomposing a Threat](/docs/Exercises/threat-profile) exercise.
...
Tradecraft is the techniques and procedures of espionage. Tradecraft is typically associated with the intelligence community. [TTPs](#ttps) and Tradecraft are used interchangeably in this course. See [Red Team Tradecraft and TTP Guidance](/docs/Planning/red-team-tradecraft).
...
TTPs are Tactics, Techniques and Procedures (sometimes called Tools, Techniques, and Procedures). The [MITRE ATT&CK framework](/docs/Concepts/mitre_attack) provides a structured catalog of known adversary TTPs. See [Red Team Tradecraft and TTP Guidance](/docs/Planning/red-team-tradecraft) for how to apply TTPs in engagements.
...
In terms of business risk, a vulnerability assessment should be considered an attack surface reduction effort as mitigation of the findings will ultimately lead to a reduction in the attack surface. See [Red Team Engagement vs Penetration Test vs Vulnerability Assessment](/docs/Concepts/red-vs-pen-vs-vuln) for a detailed comparison.
