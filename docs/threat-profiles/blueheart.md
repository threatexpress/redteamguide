...
description: "BLUEHEART threat profile example for red team adversary emulation exercises"
sidebar_position: 2
keywords: [threat profile, BLUEHEART, adversary emulation, red team exercise, threat actor profile]
---
