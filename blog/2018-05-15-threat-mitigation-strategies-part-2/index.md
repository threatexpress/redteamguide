---
title: 'Threat Mitigation Strategies: Part 2'
authors: [james]
tags:
  - threat-mitigation
...
<!-- truncate -->
![minis_io defender](./20180515_094034_defend-300x300.png)
...
2. users\appdatalocal
3. users\appdatalocaltemp
4. users\appdataroaming
5. programdata
```
...
`index=sysmon ParentImage="*\apache*" ParentImage="* omcat*" ParentImage="* ginx*" ParentImage="*\httpd*" ParentImage="*\php-cgi*" ParentImage="*\w3wp*" CommandLine="*whoami*" CommandLine="*net*" CommandLine="*ipconfig*" CommandLine="*hostname*" CommandLine="*systeminfo*" CommandLine="*cmd*" CommandLine="*sh*" CommandLine="*bash*" CommandLine="*powershell*"`
